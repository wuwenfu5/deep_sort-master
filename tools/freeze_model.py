...
def parse_args():
    ...
    parser.add_argument(
        "--graphdef_out",
        default="resources/networks/mars-small128-tf13.pb")
...
def main():
    ...
    with tf.Session(graph=tf.Graph()) as session:
        ...
        saver.restore(session, '/home/wuwenfu5/PycharmProjects/deep_sort-master/resources/networks/mars-small128.ckpt-68577')

        output_graph_def = tf.graph_util.convert_variables_to_constants(
            session, tf.get_default_graph().as_graph_def(),
            [features.name.split(":")[0]])
        with tf.gfile.GFile('/home/wuwenfu5/PycharmProjects/deep_sort-master/resources/networks/mars-small128-tf13.pb',
                            "wb") as file_handle:
